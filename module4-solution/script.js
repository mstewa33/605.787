...
(function(window){
    ...
    names.reduce(function(initialValue, currentName){
        if (currentName.charAt(0).toLowerCase() == 'j') {
            initialValue.goodbye.push(byeSpeaker.speakSimple(currentName));
        } else {
            initialValue.hello.push(helloSpeaker.speakSimple(currentName));
        }
    ...
    for(var i = 0; i < reducedNames.goodbye.length; i++){
        console.log(reducedNames.goodbye[i]);
    }
